...
function getProducts(){
  ...
  .then(data =>{
    console.log(data.responses[0][0].params.recommendedProducts.SizeÖzel.shippingFee);
    var html ="";
    data.responses[0][0].params.recommendedProducts.SizeÖzel.forEach(recommendedProducts =>{
      html += ` 
